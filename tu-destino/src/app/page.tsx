...
export default function Home() {
  const place = {
    title: "Title Place",
    description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Esse repellat maxime ab molestiae provident, mollitia expedita nostrum veniam, minus est consequuntur aspernatur nesciunt incidunt excepturi explicabo tenetur eum? Animi, reprehenderit?",
