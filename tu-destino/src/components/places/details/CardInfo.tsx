...
const CardInfo :React.FC = () =>{
    return (
        <section className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-6 md:p-12'>
            <div className="bg-blue-300 h-auto shadow-lg rounded-md flex flex-col item-center w-full justify-center">
