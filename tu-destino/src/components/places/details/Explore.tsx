...
const Explore: React.FC = () => {
  ...
  return (
    <section className='flex flex-col justify-center items-center py-[18rem]'>
      ...
      <div className='w-full md:w-[43%] h-auto  text-center'>
        <p className='text-[#86868b] mt-4 mx-16 mb-0 text-clamptext'>
          <strong className='text-[#000000ad]'>Descubre una nueva dimensión</strong> en la planificación de tu próximo destino con la fascinante experiencia de Realidad Virtual (VR) de <strong className='text-[#89c0ff]'>Tu Destino. </strong>
